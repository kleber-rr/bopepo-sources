...
/**
 * <p>
 * Ã‰ a representaÃ§Ã£o do documento Boleto que por sua vez, representa tÃ­tulos 
 * em cobranÃ§a.
 * </p>
 * 
 * <p>
 * A classe encapsula os atributos integrantes e as funcionalidades inerentes 
 * Ã  construÃ§Ã£o de tal documento.
 * </p>
 * 
 * 
 ...
 * @author <a href="mailto:samuelvalerio@gmail.com">Samuel ValÃ©rio</a>
 * 
 * @since 0.2
 * 
 * @version 0.2
...
public final class Boleto {
	...
	/**
	 * Apenas cria um instÃ¢cia do boleto com os dados nulos. 
	 */
	public Boleto() {
		super();
	}
	...
	public Boleto(Titulo titulo)throws IllegalArgumentException, NotSupportedBancoException, NotSupportedCampoLivreException{
		...
		if(isNotNull(titulo)){
			...
			IllegalArgumentException e = new IllegalArgumentException("TÃ­tulo nulo!");
			log.error("Valor NÃ£o Permitido!",e);
			throw e;
		}
	...
	private void load(){
		...
		for(int i=0; i < codigoDeBarras.size(); i++) {
			System.out.println("COdigo barras: " + codigoDeBarras.get(i).write());
		}
	...
	private void setCampoLivre(CampoLivre campoLivre) {
		...
		if (length == CampoLivre.STRING_LENGTH) {
			...
			if (length > CampoLivre.STRING_LENGTH) {
				Exceptions.throwIllegalArgumentException("O tamanho da String [" + length + "] Ã© maior que o especificado [" + CampoLivre.STRING_LENGTH + "]!");
				
			} else {
				Exceptions.throwIllegalArgumentException("O tamanho da String [" + length + "] Ã© menor que o especificado [" + CampoLivre.STRING_LENGTH + "]!");
			}
		}
	}
	...
	/**
	 * <p>
	 * Data de emissÃ£o do boleto de cobranÃ§a.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * PossÃ­veis locais para pagamento.
	 * </p>
	 * <p>
	 * Exemplo: <em>PagÃ¡vel preferencialmente na Rede X ou em qualquer Banco atÃ© 
	 * o Vencimento.</em>
	 * </p>
	 * 
	...
	/**
	 * <p>
	 *  InstruÃ§Ã£o adicional ao sacado, para visualizar o conceito de negÃ³cio de sacado consultar o 
	 * <a href="http://www.jrimum.org/bopepo">glossÃ¡rio</a>.
	 * </p>
	 * 
